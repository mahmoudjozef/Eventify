  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Text(AppLocalizations.of(context)!.language, style: AppStyle.medium18Black.copyWith(
            ...
            }, icon: Icon(Icons.arrow_forward_ios_outlined,color: providerTheme.isLightMode()?AppColor.mainColorLight:AppColor.mainColorDark,))
          ],
        ),
      ),
    );
